...
coil_A_1_pin = digitalio.DigitalInOut(board.D12)
coil_A_2_pin = digitalio.DigitalInOut(board.D16)
coil_B_1_pin = digitalio.DigitalInOut(board.D20)
coil_B_2_pin = digitalio.DigitalInOut(board.D21)
